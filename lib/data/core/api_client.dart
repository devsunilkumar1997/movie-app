...
class ApiClient {
  ...
  dynamic get(String path, {Map<dynamic, dynamic>? params, required Map<String, String> headers}) async {
  ...
  Uri getPath(String path, Map<dynamic, dynamic>? params) {
    ...
    return Uri.parse(
        '${ApiConstant.BASE_URL}$path?api_key=${ApiConstant.API_KEY}$paramsString');
  }
}
