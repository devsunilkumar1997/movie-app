...
import 'package:movieapp/domain/entities/usecases/get_favourite_movies.dart';
import 'package:movieapp/domain/entities/usecases/get_preferred_theme.dart';
import '../data/repository/app_repository_impl.dart';
import '../data/repository/authentication_repository.dart';
import '../data/repository/movie_repository_impl.dart';
import '../domain/entities/repository/app_repository.dart';
import '../domain/entities/repository/authentication_repository.dart';
import '../domain/entities/repository/movie_repository.dart';
import '../domain/entities/usecases/check_if_favourite_movie.dart';
import '../domain/entities/usecases/delete_favourite_movies.dart';
import '../domain/entities/usecases/get_cast.dart';
import '../domain/entities/usecases/get_coming_soon.dart';
import '../domain/entities/usecases/get_movie_detail.dart';
import '../domain/entities/usecases/get_playing_now.dart';
import '../domain/entities/usecases/get_popular.dart';
import '../domain/entities/usecases/get_preferred_language.dart';
import '../domain/entities/usecases/get_trending.dart';
import '../domain/entities/usecases/get_videos.dart';
import '../domain/entities/usecases/login_user.dart';
import '../domain/entities/usecases/logout_user.dart';
import '../domain/entities/usecases/save_movie.dart';
import '../domain/entities/usecases/search_movies.dart';
import '../domain/entities/usecases/update_language.dart';
import '../domain/entities/usecases/update_theme.dart';
...
import '../presentation/blocs/video/videos_cubit.dart';

import '../presentation/themes/theme_cubit.dart';
